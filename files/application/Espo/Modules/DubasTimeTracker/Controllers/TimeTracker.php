...
class TimeTracker extends \Espo\Core\Controllers\Record
{
    public function postActionGetTimerIdByTarget($params, $data, $request)
    {
        ...
        return $this->getRecordService()->getTimerIdByTarget($data->targetType, $data->targetId);
    }
}
