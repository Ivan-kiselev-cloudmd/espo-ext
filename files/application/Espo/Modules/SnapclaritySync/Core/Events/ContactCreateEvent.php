...
class ContactCreateEvent extends BaseEventHandler
{
    /**
     * @var Container
     */
    ...
    {
        $this->eventHandlers = [
            AutomatedEmailsTrackingRelateToContact::class,
            MedicalIntakeRelateToContact::class,
            BenefitRelateToContact::class,
            BenefitOptionRelateToContact::class,
