...
Espo.define('dubas-time-tracker:views/time-entry/record/detail', 'views/record/detail', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:dateEnd', function () {
                this.controlRequiredFields();
            }, this);
        ...
        controlRequiredFields: function () {
            if (this.model.get('dateEnd')) {
                this.setFieldRequired('dateEnd');
            } else {
                this.setFieldNotRequired('dateEnd');
            }
        },
    });
});
